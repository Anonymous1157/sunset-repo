...
# Source: =media-libs/amdvlk-2023.1.3 from Guru overlay
...
PATCHES=(
	...
	"${FILESDIR}/amdvlk-2023.1.2-gcc-13.patch"
)
...
multilib_src_install() {
	# Kludge, trying to run eclass install functions calls ninja but this project is strange and wants to use cmake to install
#	${CMAKE_BINARY} --install --component icd
	cmake_src_install
}
