...
# Source: =net-im/telegram-desktop-4.8.4-r2 from default Gentoo overlay
...
SLOT="0"
# Need glibmm >=2.77 which is not in Gentoo yet
...
PATCHES=(
	...
	"${FILESDIR}/64gram-1.0.88-system-cppgir.patch"
	"${FILESDIR}/64gram-1.0.88-fix-clang.patch"
